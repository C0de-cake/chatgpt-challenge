...
describe('Profile Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 'f0a092d6-8141-4c62-b5f6-82b48bcec5e4' };
      profile.user = user;

      const userCollection: IUser[] = [{ id: 'd226b7d1-37ca-419b-8f2e-01812522c1c2' }];
    ...
    it('Should update editForm', () => {
      const profile: IProfile = { id: 456 };
      const user: IUser = { id: 'dd368264-b13d-4e03-bc0c-413c4436e836' };
      profile.user = user;
