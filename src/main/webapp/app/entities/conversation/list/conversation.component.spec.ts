...
describe('Conversation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'conversation', component: ConversationComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to conversationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConversationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConversationIdentifier).toHaveBeenCalledWith(entity);
