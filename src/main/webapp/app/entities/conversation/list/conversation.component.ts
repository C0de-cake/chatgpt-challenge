...
import { EntityArrayResponseType, ConversationService } from '../service/conversation.service';
...
export class ConversationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IConversation): number => this.conversationService.getConversationIdentifier(item);
