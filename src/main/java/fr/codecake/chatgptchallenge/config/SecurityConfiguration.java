...
import fr.codecake.chatgptchallenge.security.*;
import fr.codecake.chatgptchallenge.security.SecurityUtils;
import fr.codecake.chatgptchallenge.security.oauth2.AudienceValidator;
import fr.codecake.chatgptchallenge.security.oauth2.CustomClaimConverter;
import fr.codecake.chatgptchallenge.security.oauth2.JwtGrantedAuthorityConverter;
import fr.codecake.chatgptchallenge.web.filter.SpaWebFilter;
import java.util.*;
